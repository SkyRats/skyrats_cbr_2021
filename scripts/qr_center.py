            ...
            if len(contours) > 1:
                ...
                for cnt in contours:
                    ...
                    try: 
                        ...
                        self.qrcode_center.z = (max_w * max_h) / ( self.rows *  self.cols)

                        print("Centro x: " + str(self.qrcode_center.x ))
                        print("Centro y: " + str(self.qrcode_center.y ))
                        print("Area ratio: " + str(self.qrcode_center.z))
                    except ZeroDivisionError:
                        pass
                for b in range(40):
                    self.qrcode_center_publisher.publish(self.qrcode_center)
                    self.rate.sleep()
